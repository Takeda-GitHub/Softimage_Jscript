...
// Executed Thu May 17 18:27:30 UTC+0900 2012 by t.takeda
// 
...
function XSILoadPlugin( in_reg )
{
	...
	in_reg.Name = "Render_MemoPlugin";
	in_reg.Major = 1;
	in_reg.Minor = 0;

	in_reg.RegisterCommand("Render_Memo","Render_Memo");
	in_reg.RegisterMenu(siMenuTbRenderRenderID,"Render_Memo_Menu",false,false);
...
function Render_Memo_Init( in_ctxt )
{
	var oCmd;
	oCmd = in_ctxt.Source;
	oCmd.Description = "";
...
function Render_Memo_Execute(  )
{

Application.LogMessage("Render_Memo_Execute called",siVerbose);
...
var OutPath_A = oPasses(0).GetResolvedArchivePath("");
...
function Render_Memo_Menu_Init( in_ctxt )
{
	var oMenu;
	oMenu = in_ctxt.Source;
	oMenu.AddCommandItem("Render_Memo","Render_Memo");
	return true;
}
